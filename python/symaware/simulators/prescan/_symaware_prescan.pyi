...
class _Entity:
    ...
    def __init__(
        self, object_type: _Environment.ObjectType, setup: _Entity.Setup = ..., entity_model: _EntityModel = None
    ) -> None: ...
    def __repr__(self) -> str: ...
...
class _Environment:
    class ObjectType:
        ...
        ADAC_target_yellow_merc: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.ADAC_target_yellow_merc: 0>
        ...
        CornerReflector176_8mm: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.CornerReflector176_8mm: 52>
        CornerReflector46_35mm: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.CornerReflector46_35mm: 53>
        ...
        Existing: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Existing: 65>
        FAW_Jiefang_J6M: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.FAW_Jiefang_J6M: 66>
        FShape150cm: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.FShape150cm: 67>
        FShape250cm: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.FShape250cm: 68>
        FShape350cm: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.FShape350cm: 69>
        Factory: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Factory: 272>
        Female_Bending: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_Bending: 70>
        Female_Leaning: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_Leaning: 71>
        Female_Overweight: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_Overweight: 72>
        Female_Regular: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_Regular: 73>
        Female_wBuggy: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_wBuggy: 74>
        Female_wLongCoat: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_wLongCoat: 75>
        Female_wRaincoat: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_wRaincoat: 76>
        Female_wShoppingCart: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Female_wShoppingCart: 77>
        Fence: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Fence: 275>
        Fiat_Bravo_Hatchback: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Fiat_Bravo_Hatchback: 78>
        FireBrigade: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.FireBrigade: 79>
        Ford_Fiesta_Hatchback: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Ford_Fiesta_Hatchback: 80>
        Ford_Focus_Stationwagon: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Ford_Focus_Stationwagon: 81>
        Full_Trailer: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Full_Trailer: 82>
        Garage_Ground_Floor: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Garage_Ground_Floor: 83>
        Garage_Mid_Floor: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Garage_Mid_Floor: 84>
        Garage_Top_Floor: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Garage_Top_Floor: 85>
        GasStation: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.GasStation: 86>
        Genesis_GV80: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Genesis_GV80: 87>
        Guardrail: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Guardrail: 274>
        GuardrailReflector_RectR: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RectR: 88>
        GuardrailReflector_RectW: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RectW: 89>
        GuardrailReflector_RectWR: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RectWR: 90>
        GuardrailReflector_RoundR: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RoundR: 91>
        GuardrailReflector_RoundW: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RoundW: 92>
        GuardrailReflector_RoundWR: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RoundWR: 93>
        GuardrailReflector_RoundY: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.GuardrailReflector_RoundY: 94>
        GuidedSoftTarget: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.GuidedSoftTarget: 95>
        HOWO_T5G_Cement_Truck: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.HOWO_T5G_Cement_Truck: 96>
        Hino_Blue_Ribbon: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Hino_Blue_Ribbon: 97>
        Honda_Pan_European_Motorcycle: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Honda_Pan_European_Motorcycle: 98>
        ...
        HouseModern: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseModern: 100>
        HouseOld1: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseOld1: 101>
        HouseOld2: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseOld2: 102>
        HouseOld3: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseOld3: 103>
        HouseOld4: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseOld4: 104>
        HouseOld5: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseOld5: 105>
        HouseOld6: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.HouseOld6: 106>
        Houses1930s: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Houses1930s: 107>
        Hyundai_Ioniq5: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Hyundai_Ioniq5: 108>
        Hyundai_i30_NLine: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Hyundai_i30_NLine: 109>
        Isuzu_DMax: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Isuzu_DMax: 110>
        Isuzu_Giga_Fire_Truck: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Isuzu_Giga_Fire_Truck: 111>
        JAC_HFC_Series: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.JAC_HFC_Series: 112>
        JapaneseMaple10y: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.JapaneseMaple10y: 113>
        JapaneseMaple20y: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.JapaneseMaple20y: 114>
        Joby_Aviation_S4: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Joby_Aviation_S4: 115>
        Kia_EV6: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Kia_EV6: 116>
        Kia_EV6_wRoofRack: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Kia_EV6_wRoofRack: 117>
        Kia_EV6_wRoofRack_Siemens: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Kia_EV6_wRoofRack_Siemens: 118>
        Lexus_GS_450h_F_Sport_Sedan: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Lexus_GS_450h_F_Sport_Sedan: 119>
        Lexus_LS_600h_F_Sport: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Lexus_LS_600h_F_Sport: 120>
        LightPost: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.LightPost: 121>
        Lilac10y: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Lilac10y: 122>
        Lilac20y: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Lilac20y: 123>
        LinePlacedRoadImperfection: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.LinePlacedRoadImperfection: 276>
        Magnolia10y: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Magnolia10y: 124>
        Magnolia20y: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Magnolia20y: 125>
        Male_200: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_200: 126>
        Male_African: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_African: 127>
        Male_Bending: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_Bending: 128>
        Male_BendingOver: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_BendingOver: 129>
        Male_CyclingCyclist: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_CyclingCyclist: 130>
        Male_Female_HandInHand: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Male_Female_HandInHand: 131>
        Male_LargeShoulderSuitcase: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Male_LargeShoulderSuitcase: 132>
        Male_Leaning: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_Leaning: 133>
        Male_LeaningBack: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_LeaningBack: 134>
        Male_LyingDown: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_LyingDown: 135>
        Male_Old_White_WithStick: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Male_Old_White_WithStick: 136>
        Male_Old_White_WithWalker: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Male_Old_White_WithWalker: 137>
        Male_Old_White_WithWalkerWithWheels: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Male_Old_White_WithWalkerWithWheels: 138>
        Male_Overweight: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_Overweight: 139>
        Male_Regular: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_Regular: 140>
        Male_ShoppingBag: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_ShoppingBag: 141>
        Male_Sitting: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_Sitting: 142>
        Male_wBackpack: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wBackpack: 143>
        Male_wBicycle: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wBicycle: 144>
        Male_wLargeBackpack: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wLargeBackpack: 145>
        Male_wLongCoat: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wLongCoat: 146>
        Male_wRaincoat: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wRaincoat: 147>
        Male_wSuit: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wSuit: 148>
        Male_wSuitcase: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Male_wSuitcase: 149>
        Man_250: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Man_250: 150>
        Man_Asian: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Man_Asian: 151>
        Mazda_RX8_Coupe: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Mazda_RX8_Coupe: 152>
        ...
        Mitsubishi_Outlander_PHEV: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Mitsubishi_Outlander_PHEV: 156>
        Monument: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Monument: 157>
        NCAP_Adult: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_Adult: 158>
        NCAP_Child: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_Child: 159>
        NCAP_Cyclist: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_Cyclist: 160>
        NCAP_EBTA: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_EBTA: 161>
        NCAP_GVT: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_GVT: 162>
        NCAP_Motorcycle: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_Motorcycle: 163>
        NCAP_Scooter: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_Scooter: 164>
        NCAP_StreetLight: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.NCAP_StreetLight: 165>
        NL_Ambulance_Volvo_XC60: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.NL_Ambulance_Volvo_XC60: 166>
        Nissan_Ariya: typing.ClassVar[_Environment.ObjectType]  # value = <ObjectType.Nissan_Ariya: 167>
        Nissan_Cabstar_Boxtruck: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Nissan_Cabstar_Boxtruck: 168>
        ...
        Peterbilt_579_Trailer: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Peterbilt_579_Trailer: 194>
        ...
        PrismSignV_80_100_110: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.PrismSignV_80_100_110: 198>
        ...
        SignalCasing30cmDH_US: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.SignalCasing30cmDH_US: 224>
        ...
        SignalCasing3_30cm_KR: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.SignalCasing3_30cm_KR: 228>
        SignalCasing4_30cm_KR: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.SignalCasing4_30cm_KR: 229>
        ...
        Suzuki_Hustler_Hybrid: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Suzuki_Hustler_Hybrid: 238>
        ...
        Toyota_Yaris_Hatchback: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.Toyota_Yaris_Hatchback: 246>
        ...
        TriangleParkingSpaceLock: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.TriangleParkingSpaceLock: 250>
        ...
        VehicleSignal30cm_FL_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignal30cm_FL_JP: 254>
        VehicleSignal30cm_FR_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignal30cm_FR_JP: 255>
        VehicleSignal30cm_F_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignal30cm_F_JP: 256>
        VehicleSignal30cm_L_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignal30cm_L_JP: 257>
        VehicleSignal30cm_R_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignal30cm_R_JP: 258>
        VehicleSignalGreen30cm_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignalGreen30cm_JP: 259>
        VehicleSignalOrange30cm_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignalOrange30cm_JP: 260>
        VehicleSignalRed30cm_JP: typing.ClassVar[
            _Environment.ObjectType
        ]  # value = <ObjectType.VehicleSignalRed30cm_JP: 261>
        ...
        __members__: typing.ClassVar[
            dict[str, _Environment.ObjectType]
    ...
    class WeatherType:
        ...
        __members__: typing.ClassVar[
            dict[str, _Environment.WeatherType]
